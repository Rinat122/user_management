...
if __name__ == "__main__":
    ...
    # Update user
    updated_user = User(user_id, "Rinat", "Kubanychbekov", datetime(2005, 3, 21))
    updated_user.email = UserUtil.generate_email("Rinat", "Kubanychbekov", "gmail.com")
